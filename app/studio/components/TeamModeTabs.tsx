...
export function TeamModeTabs(props: {
  ...
  const inactive = "flex-1 appearance-none border-0 bg-transparent text-ink/55 font-mono text-[10.5px] font-bold tracking-[0.05em] uppercase px-[4px] py-[9px] rounded-lg cursor-pointer tab-transition";
